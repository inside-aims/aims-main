...
const grid = [
  ...
  },
  {
    ...
    description:
      "Schedule and automate your social media posts across multiple platforms to save time maintain a consistent online presence.",
  },
  {
    title: "Advanced Analytics",
    description:
      "Gain insights into your social media performance with detailed analytics and reporting tools to measure engagement ROI.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Monitor social media conversations and trends to stay informed about what your audience is saying respond in real-time.",
  },
  {
