                ...
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className="inline-block h-8 w-8 rounded-full bg-gradient-to-r from-gray-700 to-gray-600 ring-2 ring-black"
                      />
                    ))}
                  </div>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -5 }}
              className="group relative overflow-hidden rounded-2xl bg-gray-900/50 p-8 backdrop-blur-xl"
            >
